...
SYSTEM_PROMPT = (
    ...
    "When a user tells you what API they want to build a connector for, immediately populate all three fields in one pass:\n"
    ...
    "Do all of these steps automatically in your first response - don't wait for the user to ask for documentation URLs.\n"
