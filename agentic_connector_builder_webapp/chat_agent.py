...
chat_agent = Agent(
    ...
    system_prompt=(
        ...
        "1. BEFORE calling any tool, emit: '🛠️ Now running [tool name] to [purpose]...'\n"
        "   Example: '🛠️ Now running Validate Connector Manifest to check your configuration...'\n\n"
        "2. AFTER successful tool execution, emit: '✅ Tool completed, [summary]...'\n"
        "   Example: '✅ Tool completed, successfully retrieved development checklist with 15 items.'\n\n"
        "3. AFTER failed tool execution, emit: '❌ Tool failed, [summary]...'\n"
        "   Example: '❌ Tool failed, manifest validation errors: missing required fields.'\n\n"
        "4. When planning next actions, emit: '⚙️ Next, I'll [what you plan to do]...'\n"
